...
class StateNodeMap(_object):
    ...
    def __len__(self) -> "std::map< StateNode,double >::size_type":
    ...
    def __getitem__(self, key: 'std::map< StateNode,double >::key_type const &') -> "std::map< StateNode,double >::mapped_type const &":
        return _infomap.StateNodeMap___getitem__(self, key)

    def __delitem__(self, key: 'std::map< StateNode,double >::key_type const &') -> "void":
        return _infomap.StateNodeMap___delitem__(self, key)

    def has_key(self, key: 'std::map< StateNode,double >::key_type const &') -> "bool":
    ...
    def __contains__(self, key: 'std::map< StateNode,double >::key_type const &') -> "bool":
    ...
    def size(self) -> "std::map< StateNode,double >::size_type":
        return _infomap.StateNodeMap_size(self)

    def swap(self, v: 'StateNodeMap') -> "void":
        return _infomap.StateNodeMap_swap(self, v)

    def begin(self) -> "std::map< StateNode,double >::iterator":
        return _infomap.StateNodeMap_begin(self)

    def end(self) -> "std::map< StateNode,double >::iterator":
        return _infomap.StateNodeMap_end(self)

    def rbegin(self) -> "std::map< StateNode,double >::reverse_iterator":
        return _infomap.StateNodeMap_rbegin(self)

    def rend(self) -> "std::map< StateNode,double >::reverse_iterator":
        return _infomap.StateNodeMap_rend(self)

    def clear(self) -> "void":
        return _infomap.StateNodeMap_clear(self)

    def get_allocator(self) -> "std::map< StateNode,double >::allocator_type":
        return _infomap.StateNodeMap_get_allocator(self)

    def count(self, x: 'std::map< StateNode,double >::key_type const &') -> "std::map< StateNode,double >::size_type":
        return _infomap.StateNodeMap_count(self, x)

    def erase(self, *args) -> "void":
        return _infomap.StateNodeMap_erase(self, *args)

    def find(self, x: 'std::map< StateNode,double >::key_type const &') -> "std::map< StateNode,double >::iterator":
        return _infomap.StateNodeMap_find(self, x)

    def lower_bound(self, x: 'std::map< StateNode,double >::key_type const &') -> "std::map< StateNode,double >::iterator":
        return _infomap.StateNodeMap_lower_bound(self, x)

    def upper_bound(self, x: 'std::map< StateNode,double >::key_type const &') -> "std::map< StateNode,double >::iterator":
...
class UIntDeque(_object):
    ...
    def swap(self, v: 'UIntDeque') -> "void":
...
def init(flags: 'std::string const &') -> "Config":
...
class Infomap(_object):
    ...
    def __init__(self, flags: 'std::string const'):
    ...
    def readInputData(self, filename: 'std::string') -> "void":
        return _infomap.Infomap_readInputData(self, filename)

    def addLink(self, n1: 'unsigned int', n2: 'unsigned int', weight: 'double'=1.0) -> "bool":
...
class MemInfomap(_object):
    ...
    def addTrigram(self, n1: 'unsigned int', n2: 'unsigned int', n3: 'unsigned int', weight: 'double'=1.0) -> "bool":
        return _infomap.MemInfomap_addTrigram(self, n1, n2, n3, weight)

    def addStateLink(self, n1PriorState: 'unsigned int', n1: 'unsigned int', n2PriorState: 'unsigned int', n2: 'unsigned int', weight: 'double'=1.0) -> "bool":
        return _infomap.MemInfomap_addStateLink(self, n1PriorState, n1, n2PriorState, n2, weight)

    def addMultiplexLink(self, layer1: 'int', node1: 'int', layer2: 'int', node2: 'int', weight: 'double'=1.0) -> "void":
...
class ElapsedTime(_object):
    ...
    def __init__(self, elapsedTime: 'double'):
...
class Date(_object):
    ...
    def __sub__(self, date: 'Date') -> "ElapsedTime":
...
class Network(_object):
    ...
    def addNodes(self, names: 'StringVector') -> "unsigned int":
        return _infomap.Network_addNodes(self, names)

    def addLink(self, n1: 'unsigned int', n2: 'unsigned int', weight: 'double'=1.0) -> "bool":
        return _infomap.Network_addLink(self, n1, n2, weight)

    def addBipartiteLink(self, featureNode: 'unsigned int', node: 'unsigned int', swapOrder: 'bool', weight: 'double'=1.0) -> "bool":
        return _infomap.Network_addBipartiteLink(self, featureNode, node, swapOrder, weight)

    def finalizeAndCheckNetwork(self, printSummary: 'bool'=True, desiredNumberOfNodes: 'unsigned int'=0) -> "void":
        return _infomap.Network_finalizeAndCheckNetwork(self, printSummary, desiredNumberOfNodes)

    def printParsingResult(self, onlySummary: 'bool'=False) -> "void":
        return _infomap.Network_printParsingResult(self, onlySummary)

    def getParsingResultSummary(self) -> "std::string":
        return _infomap.Network_getParsingResultSummary(self)

    def printNetworkAsPajek(self, filename: 'std::string') -> "void":
        return _infomap.Network_printNetworkAsPajek(self, filename)

    def printStateNetwork(self, filename: 'std::string') -> "void":
...
class Weight(_object):
    ...
    def __iadd__(self, w: 'double') -> "Weight &":
...
class ComplementaryData(_object):
    ...
    def __init__(self, n1: 'unsigned int', n2: 'unsigned int', weight: 'double'):
    ...
    def addExactMatch(self, missing: 'unsigned int', weight: 'double') -> "void":
        return _infomap.ComplementaryData_addExactMatch(self, missing, weight)

    def addPartialMatch(self, missing: 'unsigned int', weight: 'double') -> "void":
        return _infomap.ComplementaryData_addPartialMatch(self, missing, weight)

    def addShiftedMatch(self, missing: 'unsigned int', weight: 'double') -> "void":
...
class MultiplexNetwork(MemNetwork):
    ...
    def addMultiplexLink(self, layer1: 'int', node1: 'int', layer2: 'int', node2: 'int', w: 'double') -> "void":
        return _infomap.MultiplexNetwork_addMultiplexLink(self, layer1, node1, layer2, node2, w)

    def addMemoryNetworkFromMultiplexLinks(self) -> "void":
...
class ChildEdge(_object):
    ...
    def __init__(self, source: 'SerialTypes::edgeSize_t', target: 'SerialTypes::edgeSize_t', flow: 'double'):
...
class EdgeComp(_object):
    ...
    def __call__(self, lhs: 'ChildEdge', rhs: 'ChildEdge') -> "bool":
...
class SNode(_object):
    ...
    def addChild(self, child: 'SNode') -> "void":
        return _infomap.SNode_addChild(self, child)

    def numSerializableChildEdges(self) -> "SerialTypes::edgeSize_t":
        return _infomap.SNode_numSerializableChildEdges(self)

    def printState(self, indexOffset: 'unsigned int'=0) -> "std::string":
    ...
    def serializationSize(self, writeEdges: 'bool') -> "unsigned int":
        return _infomap.SNode_serializationSize(self, writeEdges)

    def serialize(self, outFile: 'SafeBinaryOutFile &', childPosition: 'SerialTypes::childPos_t', writeEdges: 'bool') -> "void":
        return _infomap.SNode_serialize(self, outFile, childPosition, writeEdges)

    def deserialize(self, dataStream: 'SafeBinaryInFile &') -> "unsigned short":
        return _infomap.SNode_deserialize(self, dataStream)

    def deserializeEdges(self, dataStream: 'SafeBinaryInFile &', directedEdges: 'bool') -> "unsigned short":
        return _infomap.SNode_deserializeEdges(self, dataStream, directedEdges)

    def lastChild(self) -> "SNode *":
        return _infomap.SNode_lastChild(self)

    def firstChild(self) -> "SNode *":
        return _infomap.SNode_firstChild(self)

    def nextSibling(self) -> "SNode *":
    ...
    def createChildEdge(self, sourceIndex: 'SerialTypes::edgeSize_t', targetIndex: 'SerialTypes::edgeSize_t', flow: 'double', directed: 'bool') -> "bool":
...
class LeafIterator(_object):
    ...
    def __eq__(self, rhs: 'LeafIterator') -> "bool":
        return _infomap.LeafIterator___eq__(self, rhs)

    def __ne__(self, rhs: 'LeafIterator') -> "bool":
...
class TreeIterator(_object):
    ...
    def stepForward(self) -> "TreeIterator &":
    ...
    def __eq__(self, rhs: 'TreeIterator') -> "bool":
        return _infomap.TreeIterator___eq__(self, rhs)

    def __ne__(self, rhs: 'TreeIterator') -> "bool":
...
class ChildIterator(_object):
    ...
    def stepForward(self) -> "ChildIterator &":
    ...
    def __eq__(self, rhs: 'ChildIterator') -> "bool":
        return _infomap.ChildIterator___eq__(self, rhs)

    def __ne__(self, rhs: 'ChildIterator') -> "bool":
...
class HierarchicalNetwork(_object):
    ...
    def init(self, networkName: 'std::string', codelength: 'double', oneLevelCodelength: 'double') -> "void":
    ...
    def onelevelCodelength(self) -> "double":
